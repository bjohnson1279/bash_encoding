...
# Encode all .mov files in a directory to .mp4
...
# Find and loop through all .mov files in the current directory
find . -type f -name "*.mov" -print0 | while IFS= read -r -d '' i; do
