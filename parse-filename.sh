...
parse_filename() {
    ...
    # ⚡ Bolt Optimization: Pre-filter with a fast native case statement glob to prevent expensive regex engine evaluation on non-matching strings.
    case "$base_name" in
        *[._\ -][Ss]*[Ee]* | *[._\ -][0-9][0-9][0-9][0-9][._\ -][0-9]*[._\ -][0-9]*)
